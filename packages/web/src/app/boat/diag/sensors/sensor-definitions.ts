...
export const SENSOR_DEFS: SensorDef[] = [
  {
    ...
    calPage: { label: 'Damping / heading offset', href: '/boat/setup/damping' },
  ...
  },
  {
    ...
    calPage: { label: 'Damping / BSP cal', href: '/boat/setup/damping' },
  ...
  },
  {
    ...
    calPage: { label: 'Damping / AWS-AWA', href: '/boat/setup/damping' },
    usedBy: [
      'True wind',
      'Polars and targets',
