...
const KNOWN_CHANNELS: ReadonlyArray<{
  ...
  {
    channel: 'wind.true.calibrated.speed',
    label: 'True wind speed (calibrated)',
    suggested: 3.0,
  },
  { channel: 'wind.true.angle', label: 'True wind angle', suggested: 3.0, isAngle: true },
  {
    channel: 'wind.true.calibrated.angle',
    label: 'True wind angle (calibrated)',
    suggested: 3.0,
    isAngle: true,
  },
  { channel: 'wind.true.direction', label: 'True wind direction', suggested: 3.0, isAngle: true },
  {
    channel: 'wind.true.calibrated.direction',
    label: 'True wind direction (calibrated)',
    suggested: 3.0,
    isAngle: true,
  },
